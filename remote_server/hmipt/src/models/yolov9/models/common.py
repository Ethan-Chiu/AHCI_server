...
from hmipt.src.models.yolov9.utils import TryExcept
from hmipt.src.models.yolov9.utils.dataloaders import exif_transpose, letterbox
from hmipt.src.models.yolov9.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version, colorstr,
...
from hmipt.src.models.yolov9.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolo.pt', device=torch.device('cuda'), dnn=False, data=None, fp16=False, fuse=True):
        # Usage:
        #   PyTorch:              weights = *.pt
